...
bool GbmSurfacelessWayland::SupportsPresentationCallback() {
  ...
  // just blindly say it was successfull. crbug.com/859012
  return true;
}
...
void GbmSurfacelessWayland::SubmitFrame() {
  ...
  if (unsubmitted_frames_.front()->ready && !submitted_frame_) {
    ...
    OnSubmission(gfx::SwapResult::SWAP_ACK);
    OnPresentation(
...
void GbmSurfacelessWayland::OnSubmission(gfx::SwapResult result) {
