...
#ifndef UI_OZONE_PLATFORM_WAYLAND_DRM_GBM_PIXMAP_WAYLAND_H_
#define UI_OZONE_PLATFORM_WAYLAND_DRM_GBM_PIXMAP_WAYLAND_H_
...
class GbmPixmapWayland : public gfx::NativePixmap {
 public:
  ...
  // Creates bo and initializes pixmap buffer.
 ...
 private:
  ...
  std::unique_ptr<GbmBoWrapper> gbm_bo_;
...
#endif  // UI_OZONE_PLATFORM_WAYLAND_DRM_GBM_PIXMAP_WAYLAND_H_
